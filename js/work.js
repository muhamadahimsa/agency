...
const slides = [
  { name: "Contour", img: "./Images/16.webp" },
  { name: "Velum Drift", img: "./Images/13.webp" },
  { name: "Quiet Exchange", img: "./Images/14.webp" },
  { name: "Essence No. 532-8", img: "./Images/work5.webp" },
  { name: "Metal Echo", img: "./Images/15.webp" },
  { name: "Tanned Edge", img: "./Images/6.webp" },
  { name: "Humidity", img: "./Images/work1.webp" },
  { name: "Limestone Air", img: "./Images/17.webp" },
  { name: "Warm Surface", img: "./Images/18.webp" },
  { name: "Dust & Craft", img: "./Images/work4.webp" },
];
...
function animate(time) {
  ...
  meshes.forEach((mesh) => {
    ...
    // Logika mencari gambar yang paling tengah (y mendekati 0)
    const dist = Math.abs(y);
    if (dist < closestDistance) {
      closestDistance = dist;
      currentClosestIndex = index; // Ambil index dari userData yang sudah kita perbaiki
    }
  ...
  // Update DOM hanya jika index berubah
  if (currentClosestIndex !== -1 && currentClosestIndex !== activeSlideIndex) {
    ...
    // Opsional: Tambahkan efek transisi halus pakai GSAP agar teks tidak kaku
    gsap.fromTo(
      [titleElement, counterElement],
      { y: 10, opacity: 0 },
